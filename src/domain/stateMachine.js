export const ORDER_STATE_GRAPH = Object.freeze({
  ...
  EN_CURSO: Object.freeze(['LLEGUE_A_TIENDA', 'ENTREGADO', 'CANCELADO']),
  LLEGUE_A_TIENDA: Object.freeze(['PEDIDO_ABORDO', 'ENTREGADO', 'CANCELADO']),
  PEDIDO_ABORDO: Object.freeze(['LLEGUE_A_CLIENTE', 'ENTREGADO', 'CANCELADO']),
  LLEGUE_A_CLIENTE: Object.freeze(['ENTREGADO', 'CANCELADO']),
...
export const STATE_EVENTS = Object.freeze({
  ...
  LLEGUE_A_TIENDA: 'pedido.llegada_tienda',
  PEDIDO_ABORDO: 'pedido.pedido_abordo',
  LLEGUE_A_CLIENTE: 'pedido.llegada_cliente',
