...
async function registrarCobroEfectivoTx(db, { uid, montoEfectivo, pedidoId = null, origen = 'api' }) {
...
async function registrarPagoDeudaTx(db, { uid, montoPago, origen = 'panel' }) {
