...
**Ambito:** Segunda jornada del piloto comercial controlado
**Fecha:** 2026-08-01
**Referencia ejecutiva:** `GO_NO_GO_PILOTO_CONTROLADO_001.md`
**Referencia operativa:** `RUNBOOK_OPERATIVO_PILOTO_V1.md`
**Referencia de evidencia:** `EVIDENCIA_PILOTO_CONTROLADO_001.md`
...
Definir la segunda jornada del piloto comercial controlado de Nelly, manteniendo el GO vigente y usando la evidencia de la Jornada 001 como referencia de continuidad.

Este plan no modifica RC2, no abre nuevos dominios y no sustituye el runbook operativo.

## 2. Objetivo de la jornada

Validar que el piloto conserva estabilidad en una segunda corrida diaria, con la misma disciplina documental, pero permitiendo observar si la repeticion produce alguna variacion operativa.
...
- que el flujo pedido -> comercio -> repartidor -> entrega sigue sin errores bloqueantes;
- que C4, C5 y Q1 permanecen visibles;
- que la repeticion de RC2 sigue produciendo evidencia consistente.

## 3. Participantes

| Rol | Responsable / participante | Estado |
| --- | --- | --- |
| Responsable operativo | Codex | Confirmado |
| Responsable tecnico de guardia | Codex | Confirmado |
| Responsable de soporte | Codex | Confirmado |
| Comercios participantes | Muestra controlada existente | Confirmado |
| Repartidores participantes | Muestra controlada existente | Confirmado |
| Canal de soporte | Procedimiento operativo y consola | Confirmado |
...
| Horario | Jornada operativa controlada |
| Zona geografica | Tuxtla Gutierrez |
...
| Evidencia previa | Jornada 001 cerrada | Disponible |
...
| --- | --- |
| Continuar | Se agenda Jornada 003 sin cambios estructurales |
| Continuar con observaciones | Se agenda Jornada 003 con seguimiento especifico |
| Pausar | Se suspende el piloto hasta resolver hallazgos criticos |

## 12. Regla de estabilidad arquitectonica

Durante la Jornada 002:
...
- 2026-08-01: Se crea el plan operativo de Jornada 002 como continuidad de la Jornada 001 cerrada en verde.
