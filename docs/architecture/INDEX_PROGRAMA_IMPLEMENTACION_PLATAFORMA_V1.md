# INDEX PROGRAMA IMPLEMENTACION PLATAFORMA V1

## Proposito
Servir como puerta de entrada maestra del programa operativo de implementacion de la plataforma, cubriendo P1 a P5 y conectando la migracion tecnica con el congelamiento de RC1.

## Uso recomendado

1. Leer el programa operativo completo.
2. Revisar el cierre maestro de U3.
3. Entrar en P1, P2 y P3 para entender la migracion de Admin, Driver y Backend.
...
- [`U1_3_LEDGER_FINANCIERO_V1.md`](/C:/Users/hp14/OneDrive/Desktop/nelly/docs/architecture/U1_3_LEDGER_FINANCIERO_V1.md)
  - Fuente oficial del bloque financiero.
...
- [`CERTIFICACION_P17.md`](/C:/Users/hp14/OneDrive/Desktop/nelly/docs/CERTIFICACION_P17.md)
- [`P4_PILOTO_CONTROLADO_PLATAFORMA_V1.md`](/C:/Users/hp14/OneDrive/Desktop/nelly/docs/architecture/P4_PILOTO_CONTROLADO_PLATAFORMA_V1.md)
- [`P4_CIERRE_PILOTO_CONTROLADO_V1.md`](/C:/Users/hp14/OneDrive/Desktop/nelly/docs/architecture/P4_CIERRE_PILOTO_CONTROLADO_V1.md)
...
1. `U1_3_LEDGER_FINANCIERO_V1.md`
2. `CERTIFICACION_U2_NUCLEO_UNIVERSAL_V1.md`
3. `U2_PLAN_IMPLEMENTACION_NUCLEO_UNIVERSAL_V1.md`
...
- Los documentos de apoyo desarrollan unicamente su ambito especifico y no deberan duplicar el flujo integral.
- La documentacion historica se conserva exclusivamente para trazabilidad.
- Toda modificacion al flujo financiero debera reflejarse primero en el Documento Maestro Financiero.
- La validacion operativa del bloque financiero se realizara mediante la evidencia obtenida durante RC1 - Operacion Controlada.
