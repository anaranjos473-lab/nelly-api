...
| Smart Dispatch Base | FIELD TEST | Backend autoritativo, elegibilidad por capital/equipamiento/distancia, primer aceptante con transaction | Ejecutar aceptacion real con 2 repartidores compitiendo |
| Reserva Capital | FIELD TEST | Reserva transaccional en aceptacion y liberacion en entrega | Probar doble pedido con capital insuficiente despues de reserva |
